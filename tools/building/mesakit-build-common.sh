...
build() {
    ...
    *)
    ...
    for MODIFIER in ${BUILD_MODIFIERS[@]}; do
        ...
        "graphs")
            POST_BUILD_SCRIPT="mesakit-build-all-graphs.sh"
            ;;
    ...
    if [ "$PROJECT" = "." ]; then
        BUILD_FOLDER=$(pwd)
    elif [ "$PROJECT" = "mesakit" ]; then
        BUILD_FOLDER="$MESAKIT_HOME"
    else
        BUILD_FOLDER="$MESAKIT_HOME/$PROJECT"
    fi
    ...
    if [ -e "$BUILD_FOLDER" ]; then
        ...
        echo " "
        echo "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫ Building '$PROJECT'$MESAKIT_BUILD_NAME ┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓"
        echo "┋"
        ...
        if [ -z "$SHOW" ]; then
            ...
            cd $BUILD_FOLDER
            $M2_HOME/bin/mvn -DMESAKIT_DEBUG="$MESAKIT_DEBUG" $SWITCHES $BUILD_ARGUMENTS 2>&1 | $FILTER_OUT "illegal reflective access\|denied in a future release\|please consider reporting"
        ...
        echo "$PROJECT not found in $MESAKIT_HOME"
        exit 1
