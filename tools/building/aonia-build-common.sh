...
usage() {
    ...
    echo " "
    echo "       all-clean - prompt to remove cached and temporary files and aonia artifacts from ~/.m2"
    echo " "
...
build() {
    ...
    *)
    ...
    for MODIFIER in ${BUILD_MODIFIERS[@]}; do
        ...
        "clean-all")
            PRE_BUILD_SCRIPT="aonia-clean-all.sh"
            ;;

        "clean")
            PRE_BUILD_SCRIPT="aonia-clean.sh"
            ;;
        ...
        "quiet")
            addSwitch "-q -Dsurefire.printSummary=false -DAONIA_LOG_LEVEL=Warning"
            ;;

        "graphs")
            POST_BUILD_SCRIPT="aonia-build-all-graphs.sh"
            ;;
        ...
        "sparkling")
            PRE_BUILD_SCRIPT="aonia-clean-sparkling.sh"
            ;;
    ...
    if [ -z "$AONIA_DEBUG" ]; then
        AONIA_DEBUG="!Debug"
    fi

    if [ "$PROJECT" = "." ]; then
        BUILD_FOLDER=$(pwd)
    elif [ "$PROJECT" = "aonia" ]; then
        BUILD_FOLDER="$AONIA_HOME"
    else
        BUILD_FOLDER="$AONIA_HOME/$PROJECT"
    fi
    ...
    if [ ! -z "$AONIA_BUILD_NAME" ]; then
        AONIA_BUILD_NAME=" ($AONIA_BUILD_DATE $AONIA_BUILD_NAME)"
    fi

    if [ -e "$BUILD_FOLDER" ]; then

        echo " "
        echo "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫ Building '$PROJECT'$AONIA_BUILD_NAME ┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓"
        echo "┋"
        echo "┋         Build-Folder: $BUILD_FOLDER"
        echo "┋           Build-Type: $BUILD_TYPE"
        echo "┋      Build-Modifiers: $BUILD_MODIFIERS_STRING"
        echo "┋   Maven Command Line: mvn -DAONIA_DEBUG=\"$AONIA_DEBUG\" $SWITCHES $BUILD_ARGUMENTS"
        echo "┋"
        ...
        if [ -z "$SHOW" ]; then
            ...
            cd $BUILD_FOLDER
            $M2_HOME/bin/mvn -DAONIA_DEBUG="$AONIA_DEBUG" $SWITCHES $BUILD_ARGUMENTS 2>&1 | $FILTER_OUT "illegal reflective access\|denied in a future release\|please consider reporting"
        ...
        echo "┋"
        echo "┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫ Built '$PROJECT'$AONIA_BUILD_NAME ┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"
        echo " "

    else

        echo "$PROJECT not found in $AONIA_HOME"
        exit 1
