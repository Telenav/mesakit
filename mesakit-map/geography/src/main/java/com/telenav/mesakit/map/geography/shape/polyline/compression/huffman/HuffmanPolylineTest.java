...
public class HuffmanPolylineTest extends GeographyUnitTest
{
    ...
    public void testDecompress()
    {
        ...
        var compressed = new HuffmanPolyline(expected);
        var data = compressed.asBytes();
        var decompressed = new HuffmanPolyline(data);
    ...
    public void testSegment()
    {
        ...
        var line = CompressedPolyline.fromLocations(a, b);
