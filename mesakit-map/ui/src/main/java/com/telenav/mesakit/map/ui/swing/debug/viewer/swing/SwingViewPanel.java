...
import com.telenav.mesakit.map.ui.swing.debug.viewer.ViewableMap;
import com.telenav.mesakit.map.ui.swing.map.coordinates.mappers.CoordinateMapper;
import com.telenav.mesakit.map.ui.swing.map.coordinates.mappers.SwingMercatorCoordinateMapper;
import com.telenav.mesakit.map.ui.swing.map.tiles.SlippyTile;
import com.telenav.mesakit.map.ui.swing.map.tiles.SlippyTileCoordinateSystem;
import com.telenav.mesakit.map.ui.swing.map.tiles.SlippyTileGrid;
import com.telenav.mesakit.map.ui.swing.map.tiles.SlippyTileImageCache;
...
import static com.telenav.mesakit.map.ui.swing.debug.viewer.swing.SwingViewPanel.State.PAUSED;
import static com.telenav.mesakit.map.ui.swing.debug.viewer.swing.SwingViewPanel.State.RUNNING;
import static com.telenav.mesakit.map.ui.swing.debug.viewer.swing.SwingViewPanel.State.STEPPING;
...
class SwingViewPanel extends KivaKitPanel implements InteractiveView, MouseMotionListener, MouseListener, MouseWheelListener
{
    ...
    public void mouseReleased(final MouseEvent e)
    {
        ...
        if (zoomSelection != null)
        {
            ...
            final var rectangle = viewMapper.toMesaKitn(zoomSelection);
            if (DEBUG.isDebugOn())
            {
    ...
    {
        final var rectangle = viewMapper.toMesaKitn(getBounds());
