...
public class ShapeFileReader
{
    ...
    /**
     * <p>
     * Reads a Shape File from an InputStream using the default validation preferences. The default validation
     * preferences conforms strictly to the ESRI ShapeFile specification.
     * </p>
     *
     * <p>
     * The constructor will automatically read the header of the file. Thereafter, use the method next() to read all
     * shapes.
     * </p>
     *
    ...
    /**
     * <p>
     * Reads a Shape File from an InputStream using the specified validation preferences. Use this constructor when you
     * want to relax or change the validation preferences.
     * </p>
     *
     * <p>
     * The constructor will automatically read the header of the file. Thereafter, use the method next() to read all
     ...
     *
     * @return a shape object, or null when the end of the stream is reached. The returned shape object will be of one
