...
public class GraphQueryErrorListener implements ANTLRErrorListener
{
    ...
    @Override
    public void syntaxError(final Recognizer<?, ?> recognizer, final Object offendingToken, final int line, final int character, final String message, final RecognitionException e)
    {
        error = true;
