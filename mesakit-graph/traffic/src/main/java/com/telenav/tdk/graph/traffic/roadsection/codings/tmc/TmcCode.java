...
public class TmcCode extends RoadSectionCode
{
    ...
    public static class FromLongConverter extends BaseConverter<Long, TmcCode>
    {
        ...
        public FromLongConverter(final Listener<Message> listener)
        {
            super(listener);
        }
        ...
        protected TmcCode onConvert(final Long value)
        {
            ...
            final var tmc = country + Strings.alignRight(String.valueOf(region), 2, '0') + direction
                    + Strings.alignRight(String.valueOf(location), 5, '0');
            return forCode(tmc);
        }
    ...
    public static class ToLongConverter extends BaseConverter<TmcCode, Long>
    {
        ...
        public ToLongConverter(final Listener<Message> listener)
        {
            super(listener);
        }
