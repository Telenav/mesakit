...
public abstract class RoadSectionCode
{
    public static class Converter extends BaseStringConverter<RoadSectionCode>
    {
        ...
        protected RoadSectionCode onConvertToObject(final String value)
        {
            ...
            final var system = RoadSectionCodingSystem.prefix(value);
            if (system != null)
            {
                final var code = RoadSectionCodingSystem.suffix(value);
                switch (system)
                {
                    case TMC:
    ...
    public static class ListConverter extends BaseListConverter<RoadSectionCode>
    {
        ...
        public ListConverter(final Listener<Message> listener, final String delimiter)
        {
            super(listener, new Converter(listener), delimiter);
        }
    }

    public RoadSectionIdentifier asIdentifier()
    {
        return asIdentifier(true);
    }

    public abstract RoadSectionIdentifier asIdentifier(boolean lookupDatabase);

    public abstract String code();

    public abstract RoadSectionCodingSystem codingSystem();
