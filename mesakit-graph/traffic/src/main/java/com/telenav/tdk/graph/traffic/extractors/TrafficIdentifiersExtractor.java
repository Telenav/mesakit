...
import com.telenav.kivakit.graph.traffic.extractors.TrafficIdentifiersExtractor.RoadSectionIdentifierExtract;
...
public class TrafficIdentifiersExtractor extends BaseExtractor<RoadSectionIdentifierExtract, PbfWay>
{
    ...
    public TrafficIdentifiersExtractor(final Listener<Message> listener)
    {
        super(listener);
    }
