                ...
                if (isDigit(code.charAt(1)) && isDigit(code.charAt(2)))
                {
                    ...
                    if (isDirection(directionChar))
                    {
                                ...
                                && isDigit(locationString.charAt(4)))
                        {
                            ...
                            return ((((long) countryInt * TmcCode.FromLongConverter.REGION_MASK) + region)
                                    * TmcCode.FromLongConverter.DIRECTION_MASK + direction)
                                    * TmcCode.FromLongConverter.LOCATION_MASK + location;
                        }
                    }
                }
            }
