...
public class GraphTrafficUnitTest extends MapGeographyUnitTest
{
    @BeforeClass
    public static void testSetup()
    {
        GraphTrafficProject.get().initialize();
    }
    ...
    @Override
    protected GraphTrafficRandomValueFactory randomValueFactory()
    {
        return newRandomValueFactory(GraphTrafficRandomValueFactory::new);
    }
}
