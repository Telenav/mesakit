...
public class CsvRoadSectionLoader extends com.telenav.kivakit.kernel.messaging.repeaters.BaseRepeater implements RoadSectionLoader
{
    ...
    private final com.telenav.tdk.resource.Resource resource;

    private final com.telenav.kivakit.kernel.language.progress.ProgressReporter reporter;

    public CsvRoadSectionLoader(final com.telenav.tdk.resource.Resource resource,
                                final com.telenav.kivakit.kernel.language.progress.ProgressReporter reporter)
    {
    ...
    {
        return new com.telenav.kivakit.kernel.language.iteration.BaseIterator<>()
        {
            private final com.telenav.tdk.data.formats.csv.CsvReader reader = listenTo(new com.telenav.tdk.data.formats.csv.CsvReader(resource, reporter, RoadSection.CSV_SCHEMA, ','));

            private final MessageList<com.telenav.kivakit.kernel.messaging.Message> messages = new MessageList<>(new com.telenav.kivakit.kernel.messaging.filters.operators.All<>());
