...
public class CurvatureHeadingSlopeSequence
{
    ...
    {
        final var curvatures = new ObjectList<AdasCurvature>(Maximum.maximum(count()));
    ...
    {
        final var headings = new ObjectList<Heading>(Maximum.maximum(count()));
        for (var index = 0; index < size(); index++)
        {
    ...
    {
        final var slopes = new ObjectList<Slope>(Maximum.maximum(count()));
        for (var index = 0; index < size(); index++)
        {
