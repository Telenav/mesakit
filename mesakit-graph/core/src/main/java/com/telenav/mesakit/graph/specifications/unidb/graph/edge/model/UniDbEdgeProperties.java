...
package com.telenav.mesakit.graph.specifications.unidb.graph.edge.model;
...
{
    private static final Lazy<UniDbEdgeProperties> singleton = Lazy.of(UniDbEdgeProperties::new);
