 ...
 *     <li>{@link #vertexForNodeIdentifier(NodeIdentifier)}</li>
 ...
 *     <li>{@link #contains(RelationIdentifier)}</li>
 ...
 *     <li>{@link #routeForWayIdentifier(WayIdentifier)}</li>
 *     <li>#route</li>
 * </ul>
 * <p>
 * <b>Ways</b>
 ...
 */
public abstract class Graph extends BaseRepeater<Message> implements AsIndentedString, Named
{
     ...
     */
    private final Map<RoadSectionIdentifier, Route> routeForRoadSectionIdentifier = new BoundedMap<>();
    ...
    public final boolean contains(final MapIdentifier identifier)
    {
        ...
        {
            case NODE:
                return contains((NodeIdentifier) identifier);

            case WAY:
                return contains((WayIdentifier) identifier);

            case RELATION:
                return contains((RelationIdentifier) identifier);
     ...
     */
    public final boolean contains(final NodeIdentifier identifier)
    {
     ...
     */
    public final boolean contains(final RelationIdentifier identifier)
    {
     ...
     */
    public final boolean contains(final WayIdentifier identifier)
    {
        return edgeStore.contains(identifier);
    }
    ...
    public final Differences differencesFrom(final Graph that, final Rectangle bounds, final Maximum maximumDifferences)
    {
        ...
        {
            final var thisCount = Count.of(edges().within(bounds));
            final var thatCount = Count.of(that.edges().within(bounds));
    ...
    public final GraphElement elementForMapIdentifier(final MapIdentifier identifier)
    {
        ...
        {
            case NODE:
                return vertexForNodeIdentifier((NodeIdentifier) identifier);

            case WAY:
                final var route = routeForWayIdentifier((WayIdentifier) identifier);
                if (route != null)
                {
                    return route.first();
                }
     ...
     */
    public Route routeForWayIdentifier(final WayIdentifier wayIdentifier)
    {
     ...
     */
    public final Vertex vertexForNodeIdentifier(final NodeIdentifier identifier)
    {
     ...
     */
    public final Set<WayIdentifier> wayIdentifiers()
    {
