...
public class RelationSet implements Set<EdgeRelation>
{
                                            ...
                                            final Collection<? extends EdgeRelation> collection)
    {
        ...
        {
            return new RelationSet(maximumSize, Estimate.of(collection), (Set<EdgeRelation>) collection);
        }
        else
        {
            final var set = new RelationSet(maximumSize, Estimate.of(collection));
    ...
    {
        final var set = new RelationSet(maximum, Estimate.of(collection));
