 ...
 */
public class CompressedEdgeBulkSpatialIndexer extends BaseRepeater<Message> implements NamedObject
{
    /** Used while loading to make sorting in bulk R-Tree loader faster */
    private LongArray edgeCenter;

    public CompressedEdgeBulkSpatialIndexer(final Listener<Message> listener)
    {
    ...
    public CompressedEdgeSpatialIndex index(final Graph graph)
    {
        ...
        final var edgeCount = Count.of(edges.size());
