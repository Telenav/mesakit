...
public class ModifiedWayStore
{
    ...
    private final Map<WayIdentifier, ModifiableWay> modifiedWayForWayIdentifier = new HashMap<>();
    ...
    public ModifiableWay modifiableWay(final PbfUserIdentifier userIdentifier, final PbfUserName userName,
                                       final WayIdentifier identifier, final Polyline shape, final PbfTagList tags,
                                       final int version)
    {
        // Get any existing modified way
    ...
    public Count size()
    {
        return Count.of(modifiedWayForWayIdentifier.size());
    }
