 ...
 *
 */
public class LeftSideDrivingExtractor extends BaseExtractor<Boolean, PbfWay>
{
    public LeftSideDrivingExtractor(final Listener<Message> listener)
    {
        super(listener);
    }
    ...
    {
        return "L".equals(way.tagValue("adas:driving_side"));
    }
}
