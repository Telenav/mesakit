 ...
 *
 */
public class ComplexIntersectionExtractor extends BaseExtractor<Boolean, PbfWay>
{
    public ComplexIntersectionExtractor(final Listener<Message> listener)
    {
        super(listener);
    }
    ...
    {
        return way.tagValueIsYes("adas:complex_intersection");
    }
}
