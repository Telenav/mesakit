 ...
 *     <li>{@link #wayIdentifier()} - The {@link WayIdentifier} for the way that this edge came from</li>
 ...
 *     <li>{@link #directionalWayIdentifier()} - The {@link WayIdentifier} for this edge, but negative if the edge is reversed</li>
 * </ul>
 * <p>
 * <b>Attributes</b>
 * <ul>
 ...
 *     <li>{@link #fromNodeIdentifier()} - The {@link NodeIdentifier} of the "from" end of the edge</li>
 *     <li>{@link #toNodeIdentifier()} - The {@link NodeIdentifier} of the "to" end of the edge</li>
...
public abstract class Edge extends GraphElement implements Bounded, Intersectable, Road, LocationSequence
{
    ...
    /**
     * @return The {@link WayIdentifier} for this edge, but <i>negative</i> if the edge is reversed
     */
    public WayIdentifier directionalWayIdentifier()
    {
    ...
    public boolean hasSameStandardizedBaseNameAs(final Edge that)
    {
        ...
        if (thisName != null && thatName != null)
        {
            final var standardizer = RoadNameStandardizer.get(locale(), Mode.TDK_STANDARDIZATION);
    ...
    /**
     * @return This edge as a {@link MapIdentifier}, in this case a {@link WayIdentifier}
     * @see MapIdentifier
     */
    @Override
    public WayIdentifier mapIdentifier()
    {
    ...
    /**
     * @return The list of {@link ShapePoint}s as {@link NodeIdentifier}s. This method is only meaningful if full node
     * information is available, as determined by {@link Graph#supportsFullPbfNodeInformation()}.
     */
    public List<NodeIdentifier> shapePointNodeIdentifiers()
    {
    ...
    {
        if (Edge.DEBUG.isEnabled())
        {
            return asString();
        }
        else
        {
            return Strings.hyphenatedName(getClass()) + " " + identifierAsLong() + " " + fromVertexIdentifier() + " -> " + toVertexIdentifier();
        }
    }
