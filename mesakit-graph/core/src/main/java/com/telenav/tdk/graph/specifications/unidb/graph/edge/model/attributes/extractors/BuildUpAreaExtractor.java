 ...
 *
 */
public class BuildUpAreaExtractor extends BaseExtractor<Boolean, PbfWay>
{
    public BuildUpAreaExtractor(final Listener<Message> listener)
    {
        super(listener);
    }
    ...
    {
        return way.tagValueIsYes("adas:bua");
    }
}
