 ...
 *
 */
public class DividedRoadExtractor extends BaseExtractor<Boolean, PbfWay>
{
    public DividedRoadExtractor(final Listener<Message> listener)
    {
        super(listener);
    }

    @Override
    public Boolean onExtract(final PbfWay tags)
    {
        return tags.tagValueIsYes("adas:divided_road");
    }
}
