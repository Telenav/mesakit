...
public class BackwardOneWayExtractor extends BaseExtractor<Boolean, PbfWay>
{
    public BackwardOneWayExtractor(final Listener<Message> listener)
    {
        super(listener);
    }
    ...
    {
        if ("-1".equals(way.tagValue("oneway")))
        {
            return Boolean.TRUE;
        }
