...
{
    public RouteTypeExtractor(final Listener<Message> listener)
    {
        super(listener);
    }

    @Override
    public RouteType onExtract(final PbfWay way)
    {
        final var bits = way.tagValueAsNaturalNumber("adas:route_type");
        return bits < 0 ? null : RouteType.forBits(bits);
    }
}
