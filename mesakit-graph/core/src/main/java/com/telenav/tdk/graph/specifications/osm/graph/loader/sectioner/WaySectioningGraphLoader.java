...
public class WaySectioningGraphLoader extends BaseGraphLoader
{
    ...
    public Metadata onLoad(final GraphStore store, final GraphConstraints constraints)
    {
        ...
        information("Added $ edges, discarded $ in $", Count.of(edgeStore.count()), edgeStore.discarded(), start.elapsedSince());
        ...
        information("Added $ places, discarded $ in $", Count.of(placeStore.size()), placeStore.discarded(), startPlaces.elapsedSince());
        return raw.metadata();
    }
