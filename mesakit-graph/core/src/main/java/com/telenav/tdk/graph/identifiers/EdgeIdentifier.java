 ...
 * <p>
 * Edge identifiers have a numeric scheme that adds edge-specific information to an underlying {@link WayIdentifier},
 * which is a kind of {@link MapIdentifier} in the original source data. The method {@link #asWayIdentifier()} can be
 * used to extract the {@link WayIdentifier} from the edge identifier. {@link #asDirectionalWayIdentifier()} provides
...
public class EdgeIdentifier extends Identifier implements GraphElementIdentifier
{
    ...
    /***
     * Convert {@link EdgeIdentifier} to {@link WayIdentifier}
     *
     * @author songg
     */
    public static class ToWayIdentifierConverter extends BaseConverter<EdgeIdentifier, WayIdentifier>
    {
        public ToWayIdentifierConverter(final Listener<Message> listener)
        {
            super(listener);
        }

        @Override
        protected WayIdentifier onConvert(final EdgeIdentifier value)
        {
     ...
     */
    public WayIdentifier asDirectionalWayIdentifier()
    {
     ...
     */
    public WayIdentifier asWayIdentifier()
    {
