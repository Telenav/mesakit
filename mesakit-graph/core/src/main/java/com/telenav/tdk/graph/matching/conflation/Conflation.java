...
public class Conflation
{
    ...
    private final Percentage closeness;

    private final Distance overlap;

    Conflation(final Edge enhancing, final Edge base, final Percentage closeness, final Distance overlap)
    {
    ...
    public boolean isCloserThan(final Percentage closeness)
    {
