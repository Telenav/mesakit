...
public class IsoCountryExtractor extends BaseExtractor<Country, PbfWay>
{
    public IsoCountryExtractor(final Listener<Message> listener)
    {
        super(listener);
    }
    ...
    public Country onExtract(final PbfWay way)
    {
        ...
        if (iso != null)
        {
            ...
            if (code != null)
            {
                return Country.forRegionCode(code);
            }
        }
        return null;
    }
