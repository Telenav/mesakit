 ...
 */
public class SmartGraphLoader extends BaseRepeater<Message> implements Named
{
    ...
    public static class Converter extends BaseStringConverter<SmartGraphLoader>
    {
        ...
        public Converter(final Listener<Message> listener, final PbfToGraphConverter.Configuration configuration)
        {
            super(listener);
    ...
    public Graph load(final Listener<Message> listener, final ProgressReporter reporter)
    {
