...
public class VertexStore extends NodeStore<Vertex>
{
    ...
    public void addVertexes()
    {
        if (!vertexesAdded)
        {
            ...
            flush();
            information("Added $ vertexes, discarded $ in $", Count.of(size()), discarded(), start.elapsedSince());
        }
    }
    ...
    {
        return Count.of(connectivity().retrieveEdgeCount(vertex.index()));
    }
    ...
    {
        return Count.of(connectivity().retrieveInEdgeCount(vertex.index()));
    }
    ...
    {
        return Count.of(connectivity().retrieveOutEdgeCount(vertex.index()));
    }
