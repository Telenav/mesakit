...
public class WorldCellList extends ArrayList<WorldCell>
{
    ...
    {
        return new EdgeSequence(Iterables.iterable(() -> new NextIterable<Edge>()
        {
    ...
    {
        return RelationSet.forIterable(GraphLimits.Limit.RELATIONS, Iterables.iterable(() -> new NextIterable<>()
        {
    ...
    {
        return new VertexSequence(Iterables.iterable(() -> new NextIterable<>()
        {
            WorldCell worldCell;
