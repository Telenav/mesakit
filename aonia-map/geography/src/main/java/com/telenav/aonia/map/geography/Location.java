...
import com.telenav.aonia.map.geography.shape.rectangle.Dimensioned;
...
import com.telenav.aonia.map.geography.shape.rectangle.Offset;
 ...
 * {@link Intersectable#intersects(com.telenav.aonia.map.geography.shape.rectangle.Rectangle)}. Although a location is a zero-dimensional point, it also supports
...
public class Location implements Validatable, Located, Identifiable, Bounded, Intersectable, AsString, Serializable
{
     ...
     * com.telenav.aonia.map.geography.shape.rectangle.Rectangle#expanded(Distance)}
     */
    @Override
    public com.telenav.aonia.map.geography.shape.rectangle.Rectangle bounds()
    {
        return com.telenav.aonia.map.geography.shape.rectangle.Rectangle.fromLocations(this, this);
    }
     ...
     */
    @Override
    public boolean intersects(final com.telenav.aonia.map.geography.shape.rectangle.Rectangle rectangle)
    {
    ...
    public com.telenav.aonia.map.geography.shape.rectangle.Rectangle rectangle(final Dimensioned sized)
    {
    ...
    public com.telenav.aonia.map.geography.shape.rectangle.Rectangle within(final Distance distance)
    {
