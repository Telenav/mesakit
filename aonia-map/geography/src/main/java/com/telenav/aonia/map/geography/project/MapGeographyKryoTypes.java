...
import com.telenav.aonia.map.geography.Precision;
import com.telenav.aonia.map.geography.indexing.polygon.Leaf;
import com.telenav.aonia.map.geography.indexing.polygon.LocationArray;
import com.telenav.aonia.map.geography.indexing.polygon.PolygonSpatialIndex;
import com.telenav.aonia.map.geography.indexing.polygon.QuadrantStore;
import com.telenav.aonia.map.geography.indexing.quadtree.QuadTreeSpatialIndex;
...
import com.telenav.aonia.map.geography.indexing.rtree.RTreeSpatialIndexKryoSerializer;
import com.telenav.aonia.map.geography.indexing.rtree.UncompressedLeaf;
...
import com.telenav.aonia.map.geography.shape.polyline.compression.differential.CompressedPolyline;
...
public class MapGeographyKryoTypes extends KryoTypes
{
    public MapGeographyKryoTypes()
    {
        ...
        group("r-tree-spatial-index", () ->
        {
            ...
            register(com.telenav.aonia.map.geography.indexing.rtree.Leaf.class);
            register(Node.class);
        });
        ...
        group("polygon-spatial-index", () ->
        {
            ...
            register(Leaf.class);
            register(com.telenav.aonia.map.geography.indexing.polygon.Node.class);
