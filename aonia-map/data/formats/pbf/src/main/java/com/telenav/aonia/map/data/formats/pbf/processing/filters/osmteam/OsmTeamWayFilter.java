...
package com.telenav.aonia.map.data.formats.pbf.processing.filters.osmteam;
...
public class OsmTeamWayFilter extends WayFilter
{
    public OsmTeamWayFilter()
    {
        super("osmteam-ways", "includes only motorway, primary, secondary, tertiary, trunk, residential, road, service and unclassified ways");
