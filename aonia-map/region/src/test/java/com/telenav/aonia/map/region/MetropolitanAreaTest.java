...
public class MetropolitanAreaTest extends MapRegionUnitTest
{
    ...
    public void testAttributes()
    {
        ...
        ensureEqual("United_States-California-Metro_San_Francisco—Oakland",
                Country.UNITED_STATES.CALIFORNIA.SAN_FRANCISCO_OAKLAND.identity().aonia().code());
    }
    ...
    public void testMexicoAG()
    {
        ...
        ensureEqual("Mexico-Aguascalientes-Metro_Zona_metropolitana_de_Aguascalientes", metro.identity().aonia().code());
    ...
    public void testSpecialChars()
    {
        ...
        ensureEqual("Canada-Newfoundland_and_Labrador-Metro_St._John_s", county.identity().aonia().code());
