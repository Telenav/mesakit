...
public class CountyTest extends MapRegionUnitTest
{
    ...
    public void testAttributes()
    {
        ...
        ensureEqual("United_States-California-County_San_Mateo",
                Country.UNITED_STATES.CALIFORNIA.SAN_MATEO_COUNTY.identity().aonia().code());
    }
    ...
    public void testCountySameAsMetro()
    {
        ...
        ensureEqual("United_States-Maryland-County_Washington", county.identity().aonia().code());
        ...
        ensureEqual("United_States-Maryland-Metro_Washington", metro.identity().aonia().code());
    }
    ...
    public void testDC()
    {
        ...
        ensureEqual("United_States-District_of_Columbia", state.identity().aonia().code());
    }
    ...
    public void testSpecialCharacters()
    {
        ...
        ensureEqual("United_States-Puerto_Rico-County_Bayamón", county.identity().aonia().code());
    }
}
