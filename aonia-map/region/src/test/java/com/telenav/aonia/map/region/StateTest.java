...
public class StateTest extends MapRegionUnitTest
{
    @Test
    public void testAll()
    {
    ...
    public void testAttributes()
    {
        ...
        ensureEqual("United_States-New_Mexico", Country.UNITED_STATES.NEW_MEXICO.identity().aonia().code());
    ...
    public void testForString()
    {
        ...
        ensureEqual("Mexico-Baja_California", state.identity().aonia().code());
    ...
    public void testMexicoAG()
    {
        ...
        ensureEqual("Mexico-Aguascalientes", state.identity().aonia().code());
    ...
    public void testSpecialCharacters()
    {
        ...
        ensureEqual("North_Korea-P_yŏngyang", state.identity().aonia().code());
    ...
    public void testWithCorrectIsoCode()
    {
        ...
        ensureEqual("Canada-Yukon", state.identity().aonia().code());
    }
    ...
    public void testYetAnotherCode()
    {
        ...
        ensureEqual("Azerbaijan-Abşeron", state.identity().aonia().code());
