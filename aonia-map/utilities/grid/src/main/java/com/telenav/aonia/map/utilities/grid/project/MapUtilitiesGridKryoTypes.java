...
public class MapUtilitiesGridKryoTypes extends KryoTypes
{
    public MapUtilitiesGridKryoTypes()
    {
        ...
        group("cells", () ->
        {
            register(GridCell.class);
            register(GridCellIdentifier.class);
        });
    }
}
