...
package com.telenav.mesakit.map.geography.tests.shape.polyline.test;
...
public class PolylineTest extends UnitTest
{
    ...
    public void testIntersectionBug()
    {
        ...
        var bounds = new Rectangle.Converter(Listener.nullListener()).convert("30.9489,-84.0:32.9489,-82.0");
